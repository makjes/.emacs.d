...
#+begin_src emacs-lisp
  ...
  (defhydra mk/hydra-theme ()
    "
Switch theme: _b_lue  _d_ay  _n_ight  b_r_ight  _e_ighties  E_x_it"
    ("b" color-theme-sanityinc-tomorrow-blue nil)
    ("d" color-theme-sanityinc-tomorrow-day nil)
    ("n" color-theme-sanityinc-tomorrow-night nil)
    ("r" color-theme-sanityinc-tomorrow-bright nil)
    ("e" color-theme-sanityinc-tomorrow-eighties nil)
    ("x" nil nil :exit t))
#+end_src
