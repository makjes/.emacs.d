...
#+begin_src emacs-lisp
  ...
  (defvar mk/themes '(sanityinc-tomorrow-day
  ...
  (mk/load-theme 'spacemacs-dark)
#+end_src
*** Hydra for themes
#+BEGIN_SRC emacs-lisp
  (defhydra mk/hydra-theme ()
    "
  Switch theme: _d_ay _b_right _s_pacemacs E_x_it"
    ("d" (mk/load-theme 'sanityinc-tomorrow-day) nil)
    ("b" (mk/load-theme 'sanityinc-tomorrow-bright) nil)
    ("s" (mk/load-theme 'spacemacs-dark) nil)
    ("x" nil nil :exit t))
#+END_SRC
