...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (htmlize ox-reveal ox-ioslide-helper ox-ioslide aggressive-indent auto-complete magit monokai-theme arjen-grey-theme which-key ivy-hydra swiper use-package))))
(custom-set-faces
